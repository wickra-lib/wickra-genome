...
Wickra Genome is pre-1.0; only the latest `0.x` release line receives security
fixes.
...
[GitHub Security Advisories](https://github.com/wickra-lib/wickra-genome/security/advisories/new),
...
Wickra Genome **generates code** and can **invoke `cargo` on it**. Treat it like
