...
repository pins `genome-core` from three manifests rather than one, ships the
...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pin", r'genome-core = \{ version = "@V@", path = ', 1),
    # Two manifests pin genome-core by path *and* version instead of through
