...
repository pins `wickra-genome-core` from three manifests rather than one, ships the
...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pin", r'wickra-genome-core = \{ version = "@V@", path = ', 1),
    # Two manifests pin wickra-genome-core by path *and* version instead of through
    ...
    (
        ...
        "wickra-genome-core pin",
        r'path = "\.\./\.\./crates/genome-core", version = "@V@"',
        1,
    ),
    (
        "crates/genome-bench/Cargo.toml",
        "wickra-genome-core pin",
        r'path = "\.\./genome-core", version = "@V@"',
        1,
    ),
    ...
    (
        "bindings/csharp/WickraGenome/WickraGenome.csproj",
        "NuGet version",
        r"<Version>@V@</Version>",
        1,
    ),
    ...
    ("examples/README.md", "sample output", r"wickra-genome @V@", 1),
    ...
    (
        ...
        r'"name": "wickra-genome",\s+"version": "@V@"',
        2,
    ),
]
